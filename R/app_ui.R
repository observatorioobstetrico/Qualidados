  ...
  tagList(
    ...
    shinyjs::useShinyjs(),
            shinydashboard::dashboardPage(title="Qualidados",
              ...
              mod_construcao_ui(id = 'SINASC_implausibilidade',tabname ='implau_sinasc' ),
              mod_construcao_ui(id = 'SINASC_inconsistencia',tabname ='incon_sinasc' ),
              mod_construcao_ui(id = 'SIM_incompletude',tabname ='incom_sim' ),
              mod_construcao_ui(id = 'SIM_implausibilidade',tabname ='implau_sim' ),
              mod_construcao_ui(id = 'SIM_inconsistencia',tabname ='incon_sim' ),

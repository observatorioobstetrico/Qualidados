 ...
 **SINASC_Limpeza_e_modificacao.ipynb**, de preferencia no vscode, não rode no RSTUDIO. Esse arquivo transforma as bases na forma de leitura do qualidados.
...
Suba, assim como nos outros paineis, para o github as atualizações feitas, não subindo nenhum arquivo da pasta **data** e **data1** pois as mesmas não são suportadas pelo github pelo tamanho das bases (caso não saiba como usar o github olhe o tutorial e curso feito por samuel e pedro no drive do oobr, caso nao saiba como subir o painel olhe o tutorial de atulizacao do SRAG ou SRAG 1000 dias). As bases que  devem ser postadas no synapse são:

- 'data/dados_oobr_qualidados_SIM_Implausibilidade_1996_2022.rda'

- 'data/dados_oobr_qualidados_SIM_Inconsistencia_1996_2022.rda'

- 'data/dados_oobr_qualidados_SIM_Incompletude_1996_2022.rda'

- 'data/dados_oobr_qualidados_SINASC_Implausibilidade_1996_2022.rda'

- 'data/dados_oobr_qualidados_SINASC_Inconsistencia_1996_2022.rda'

- 'data/dados_oobr_qualidados_SINASC_Incompletude_1996_2022.rda'

- 'data/dados_oobr_qualidados_SIVEP_2009_2023.rda'
